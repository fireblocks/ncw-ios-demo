...
struct LocalizableStrings{
    ...
    static let generateKeys = "generate_keys".localize()
    ...
    static let goHome = "Go to wallet".localize()
    ...
    static let recipient = "Recipient".localize()
    ...
    static let transactionDetails = "Transfer details".localize()
    static let sent = "Sent".localize()
    static let received = "Received".localize()
    ...
    static let id = "ID".localize()
    static let fireblocksNFTId = "Fireblocks NFT ID".localize()
    static let address = "Address".localize()
    static let address_hint = "Scan or enter an address".localize()
    static let continueButton = "Continue".localize()
